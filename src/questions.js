export const questions = [
  {
    ...
    answers: [
      ...
      { text: "Hassrede, die sich gegen benachteiligte Personen oder Gruppen richtet", correct: true },
  ...
  {
    id: 3,
    question: "Was ist ein typisches Ziel von Hate Speech im Gaming?",
    answers: [
      { text: "Spieler zu motivieren", correct: false },
      { text: "Herabwürdigung anderer", correct: true },
  ...
  {
    id: 4,
    question: "Welche Gruppen sind im Gaming besonders häufig von Hate Speech betroffen?",
    answers: [
      { text: "Profispieler*innen", correct: false },
  ...
  {
    id: 5,
    question: "Was ist die beste Möglichkeit, um auf Hate Speech in einer Gaming-Community zu reagieren?",
    answers: [
      { text: "Sie ignorieren", correct: false },
      { text: "Die Täter*innen beleidigen", correct: false },
  ...
  {
    id: 7,
    question: "Was ist ein häufiger Grund für Hate Speech im Gaming?",
    answers: [
      { text: "Magnesium-Mangel", correct: false },
      { text: "Schlafentzug", correct: false },
  ...
  {
    id: 8,
    question: "Wie kann man als Spieler*in aktiv gegen Hate Speech vorgehen?",
    answers: [
  ...
  {
    id: 9,
    question: "Was ist eine mögliche Folge von Hate Speech im Gaming?",
    answers: [
      { text: "Spieler*innen steigern ihre Leistung", correct: false },
  ...
  {
    id: 11,
    question: "Welche dieser Maßnahmen kann Hate Speech in Gaming-Chats verringern?",
    answers: [
  ...
  {
    id: 12,
    question: "Warum ist Hate Speech nicht nur ein Problem für einzelne Spieler*innen?",
    answers: [
  ...
  {
    id: 13,
    question: "Was ist ein Beispiel für indirekte Hate Speech?",
    answers: [
      { text: "„Du spielst wirklich gut“", correct: false },
      { text: "„Du spielst für eine Frau wirklich gut“", correct: true },
  ...
  {
    id: 14,
    question: "Warum ist Anonymität im Gaming ein Faktor bei Hate Speech?",
    answers: [
      { text: "Sie schützt vor Cybermobbing", correct: false },
      { text: "Sie macht Täter mutiger", correct: true },
